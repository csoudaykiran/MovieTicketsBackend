...
namespace MovieTickets.Repository.MovieRepo
{
    public class MovieRepository : IMovieRepository
    {
        ...
        public MovieRepository(MovieTicketsDbContext _context, IMapper _mapper) // Dependency Injection
        ...
        public async Task<Movie> UpdateMovie(UpdateMovieModel Movie)
        {
            ...
            if (!string.IsNullOrWhiteSpace(Movie.City))
            {
                UpdateMovie.City = Movie.City;
            }
